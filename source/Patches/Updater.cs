...
namespace TownOfUs
{
    ...
    public class ModUpdaterButton
    {
        ...
        {
            var text = ModUpdater.Httpclient.GetAsync("https://github.com/TheTypholorian/All-Of-Us/raw/master/source/Versioning.json")
    ...
    public class ModUpdater
    {
        ...
        public static async Task<bool> checkForUpdate(string updateType = "TOU")
        {
            ...
            try
            {
                ...
                if (updateType == "TOU")
                {
                    githubURI = "https://api.github.com/repos/TheTypholorian/All-Of-Us/releases/latest";
                }
                else if (updateType == "Submerged")
                {
