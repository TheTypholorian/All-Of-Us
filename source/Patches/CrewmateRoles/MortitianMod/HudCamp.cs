...
namespace TownOfUs.CrewmateRoles.MortitianMod
{
    ...
    public class HudCamp
    {
        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            if (!PlayerControl.LocalPlayer.Is(RoleEnum.Mortitian)) return;
            var campButton = __instance.KillButton;

            var role = Role.GetRole<Mortitian>(PlayerControl.LocalPlayer);
