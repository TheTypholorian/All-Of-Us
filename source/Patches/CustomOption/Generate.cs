...
namespace TownOfUs.CustomOption
{
    public class Generate
    {
        ...
        public static CustomNumberOption EclipsalOn;
        ...
        public static CustomStringOption ExecutionerWin;

        public static CustomHeaderOption Phantom;
        public static CustomNumberOption PhantomTasksRemaining;
        public static CustomToggleOption PhantomWinEndsGame;
        ...
        public static CustomNumberOption InitialBlessCooldown;
        ...
        public static CustomHeaderOption Eclipsal;
        public static CustomNumberOption BlindCooldown;
        public static CustomNumberOption BlindDuration;
        public static CustomNumberOption BlindRadius;
        ...
        public static void GenerateAll()
        {
            ...
            EclipsalOn = new CustomNumberOption(num++, MultiMenu.imposter, "<color=#FF0000FF>Eclipsal</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            GiantOn = new CustomNumberOption(num++, MultiMenu.modifiers, "<color=#FFB34DFF>Giant</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ImmovableOn = new CustomNumberOption(num++, MultiMenu.modifiers, "<color=#E6E6CCFF>Immovable</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            Slot1 = new CustomStringOption(num++, MultiMenu.main, "Slot 1", new[] { "<color=#66FFFFFF>Crew</color> Investigative",
                "<color=#66FFFFFF>Crew</color> Killing", "<color=#66FFFFFF>Crew</color> Power", "<color=#66FFFFFF>Crew</color> Protective",
                "<color=#66FFFFFF>Crew</color> Support", "Common <color=#66FFFFFF>Crew</color>", "Special <color=#66FFFFFF>Crew</color>",
                "Random <color=#66FFFFFF>Crew</color>", "<color=#999999FF>Neutral</color> Benign", "<color=#999999FF>Neutral</color> Evil",
                "<color=#999999FF>Neutral</color> Killing", "Common <color=#999999FF>Neutral</color>", "Random <color=#999999FF>Neutral</color>",
                "<color=#FF0000FF>Imp</color> Concealing", "<color=#FF0000FF>Imp</color> Killing", "<color=#FF0000FF>Imp</color> Support",
                "Common <color=#FF0000FF>Imp</color>", "Random <color=#FF0000FF>Imp</color>", "Non-<color=#FF0000FF>Imp</color>", "Any" }, 18);
            ...
            Slot4 = new CustomStringOption(num++, MultiMenu.main, "Slot 4", new[] { "<color=#66FFFFFF>Crew</color> Investigative",
                ...
                "<color=#999999FF>Neutral</color> Killing", "Common <color=#999999FF>Neutral</color>", "Random <color=#999999FF>Neutral</color>",
                "<color=#FF0000FF>Imp</color> Concealing", "<color=#FF0000FF>Imp</color> Killing", "<color=#FF0000FF>Imp</color> Support",
                "Common <color=#FF0000FF>Imp</color>", "Random <color=#FF0000FF>Imp</color>", "Non-<color=#FF0000FF>Imp</color>", "Any" }, 17);
            ...
            WatchCooldown =
                new CustomNumberOption(num++, MultiMenu.crewmate, "Watch Cooldown", 10f, 1f, 15f, 1f, CooldownFormat);
            ...
            JailCooldown =
                new CustomNumberOption(num++, MultiMenu.crewmate, "Jail Cooldown", 10f, 1f, 15f, 1f, CooldownFormat);
            MaxExecutes =
            ...
            ReviveDuration =
                new CustomNumberOption(num++, MultiMenu.crewmate, "Altruist Revive Duration", 5f, 1f, 15f, 1f, CooldownFormat);
            ReviveUses =
            ...
            ConfessCooldown =
                new CustomNumberOption(num++, MultiMenu.crewmate, "Confess Cooldown", 10f, 1f, 15f, 1f, CooldownFormat);
            InitialBlessCooldown =
                new CustomNumberOption(num++, MultiMenu.crewmate, "Initial Bless Cooldown", 10f, 1f, 15f, 1f, CooldownFormat);
            ...
            GaOnTargetDeath = new CustomStringOption(num++, MultiMenu.neutral, "GA Becomes On Target Dead",
                new[] { "Crewmate", "Amnesiac", "Mercenary", "Survivor", "Jester" }, 3);
            GATargetKnows =
           ...
           JesterWin = new CustomStringOption(num++, MultiMenu.neutral, "Jester Win",
            ...
            Eclipsal =
                new CustomHeaderOption(num++, MultiMenu.imposter, "<color=#FF0000FF>Eclipsal</color>");
            BlindCooldown =
                new CustomNumberOption(num++, MultiMenu.imposter, "Blind Cooldown", 25f, 10f, 60f, 2.5f, CooldownFormat);
            BlindDuration =
                new CustomNumberOption(num++, MultiMenu.imposter, "Blind Duration", 25f, 10f, 60f, 2.5f, CooldownFormat);
            BlindRadius =
                new CustomNumberOption(num++, MultiMenu.imposter, "Blind Radius", 1f, 0.25f, 5f, 0.25f, MultiplierFormat);
